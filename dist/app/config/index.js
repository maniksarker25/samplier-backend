...
exports.default = {
    ...
    stripe: {
        ...
        stripe_campaign_run_payment_success_url: process.env.STRIPE_CAMPAIGN_RUN_PAYMENT_SUCCESS_URL,
        stripe_campaign_run_payment_cancel_url: process.env.STRIPE_CAMPAIGN_RUN_PAYMENT_CANCEL_URL,
        stripe_order_payment_success_url: process.env.STRIPE_ORDER_PAYMENT_SUCCESS_URL,
        stripe_order_payment_cancel_url: process.env.STRIPE_ORDER_PAYMENT_CANCEL_URL,
    ...
    paypal: {
        ...
        paypal_campaign_run_payment_success_url: process.env.PAYPAL_CAMPAIGN_RUN_PAYMENT_SUCCESS_URL,
